  ...
  return (
    <Disclosure as='div' onClick={onClick} className='pointer-events-none flex items-center'>
      <Disclosure.Button
        ...
        className='pointer-events-auto fixed top-1.5 right-1.5'
      >
      ...
      >
        <Disclosure.Panel className='pointer-events-auto fixed top-12 right-0 bottom-0 z-10 w-full select-none overflow-auto scroll-smooth bg-[#202022] px-4 pt-4 pb-32 text-lg sm:max-w-sm'>
