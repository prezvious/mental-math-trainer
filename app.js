...
function handleSettingChange(event) {
    ...
    switch (id) {
        ...
        case 'target-time':
            ...
            state.settings.targetTime = parsed;
            event.target.value = parsed; // reflect clamped value in UI
            break;
        case 'target-streak':
            parsed = Math.max(1, Math.min(100, parsed));
            state.settings.targetStreak = parsed;
